...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findOrderQueryDtos(){
        ...
        result.forEach( o-> {
            ...
            o.setOrderItems(orderItems);    //OrderQueryDto 에서 setter 열어 놓음
        });
        return result;
    }

    /**
     * 1:N 관계(컬렉션)를 제외한 나머지를 한번에 조회  - 루트 조회(toOne 코드를 모두 한번에 조회)
     */
    ...
    public List<OrderQueryDto> findAllByDto_optimization() {
        ...
        //orderItem 컬렉션을 MAP 한방에 조회 그리고 toOne 데이터와 한번에 붙이는 것임
